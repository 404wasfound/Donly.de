...
class JobsVC: UIViewController {
  ...
  @IBOutlet weak var buttonsStackConstraint: NSLayoutConstraint!
  ...
  func setupJobSearchButton() {
    ...
    guard viewModel?.page == .myTasks else {
      ...
      self.buttonsStackConstraint.constant = 150
      return
    }
    self.buttonsStackConstraint.constant = 300
    self.jobSearchButton.backgroundColor = donlyColor
